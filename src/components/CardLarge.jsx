const CardLarge = () => {
  return (
    <div className="relative w-full" style={{ paddingTop: '56.25%' }}> {/* 16:9 Aspect Ratio */}
      <div className="absolute inset-0 bg-[url('../public/assets/image-1.webp')] bg-cover bg-center bg-no-repeat shadow-md  transform transition duration-200 hover:scale-95 cursor-pointer">
