  ...
  return (
    <>
      ...
      <div className="hidden lg:block w-[980px] mx-auto p-4 space-y-4">
        <img className="cursor-pointer w-full" src="/marca/assets/ads/caliente-4.gif" alt="Advertisement" />
        ...
        <div className="flex flex-row gap-4">
          ...
          <div className="w-[20%] flex items-center justify-center">
            <img className="w-full" src="/marca/assets/ads/caliente-3.gif" alt="Advertisement"/>
          </div>
        </div>
        ...
        <div className="grid grid-cols-3 gap-4">
          <CardSmall
            ...
            topic="Fútbol"
            imageSrc="/marca/assets/image-2.webp"
          />
          <CardSmall
            title="Francia resucita 'sacrificando' a Mbappé"
            author="CÉSAR RAMIREZ"
            topic="America"
            imageSrc="/marca/assets/image-3.webp"
          />
          <CardSmall
      ...
      <div className="hidden sm:block lg:hidden w-full mx-auto p-4 space-y-4">
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <CardSmall
            ...
            author=""
            topic="Ad"
            imageSrc="/marca/assets/ads/caliente-7.gif"
          />
        </div>
      </div>
      ...
      <div className="block sm:hidden w-full mx-auto p-4 space-y-4">
        ...
        <img className="w-full" src="/marca/assets/ads/caliente-7.gif" alt="Advertisement" />
      </div>
    </>
  );
};
